...
export default function JapanContent() {
  ...
  const inputClass =
    'bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white text-sm w-full focus:outline-none focus:border-gold-500/50 placeholder:text-white/30';
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 mt-14 sm:mt-24">
        <GlassCard className="reveal max-w-full sm:max-w-2xl">
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              <label className="text-white/60 text-[10px] sm:text-xs tracking-wider uppercase mb-2 block">
                {t('japan.form.name')}
              </label>
              <input
                type="text"
