...
const products = [
  ...
  { icon: '🌽', titleKey: 'plantation.maize.title', descKey: 'plantation.maize.desc' },
  { icon: '🌿', titleKey: 'plantation.babycorn.title', descKey: 'plantation.babycorn.desc' },
  { icon: '🌸', titleKey: 'plantation.lily.title', descKey: 'plantation.lily.desc' },
