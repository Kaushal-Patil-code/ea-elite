  ...
  return (
    <section id="divisions" ref={sectionRef} className="py-16 sm:py-24 md:py-32 bg-navy-900">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12">
        ...
        <p className="text-white/70 text-base sm:text-lg max-w-xl mb-10 sm:mb-16">
          {t('divisions.intro')}
        </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2" style={{ transform: 'translateZ(20px)' }}>
                        ...
                        <span className="text-white/40 text-[9px] sm:text-[10px] tracking-[0.2em] uppercase">
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ transform: 'translateZ(30px)' }}>
                        ...
                        <p className="text-white/70 text-xs sm:text-sm leading-[1.8]">
                          {t(div.taglineKey)}
                        </p>
                      </div>
