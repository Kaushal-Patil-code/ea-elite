    ...
    <footer className="bg-navy-900 border-t border-white/5">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-10 sm:py-16">
        <div className="flex flex-col md:flex-row justify-between items-start gap-10">
          ...
          {/* Right: countries */}
          <div className="flex flex-wrap gap-4 sm:gap-6 md:gap-10 text-xs sm:text-sm text-white/70">
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 text-white/50 text-[10px] sm:text-xs">
            <span>eaelitetradingthailand@gmail.com</span>
            <span>eaelitetradingjapan@gmail.com</span>
          </div>
        </div>
      </div>
    </footer>
